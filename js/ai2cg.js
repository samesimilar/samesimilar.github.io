...
r = function() {
$('.img-2').attr('src', (window.devicePixelRatio > 1) ? ((window.devicePixelRatio > 2) ? 'images/tank-2880.png' : 'images/tank-1920.png') : 'images/tank-960.png');};
$(window).resize(r);
r();
if(location.protocol === 'file:')
{
$("head").append($("<link rel='stylesheet' type='text/css' href='http://fonts.googleapis.com/css?family=PT+Sans:400,400i|EB+Garamond|Muli&amp;subset=all'></link>"));
}
